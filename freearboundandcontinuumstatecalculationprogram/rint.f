...
c   Simple integration program
      ...
      dimension fn(200),x(200)
        ...
        x(i)=i*b
        fn(i)=(x(i)*x(i)*x(i))/2
        write(8,*)x(i),fn(i),b,n1,n2
 300  continue
C        write(6,*) result,n1,n2
        call rint(fn,n1,n2,7,b)
        end



***********************************************************************
      subroutine rint (f,na,nb,nq,h)
...
c
 ...
 100  continue
      a = a/d(nq)
        write(16,*) f(100),h,l,m
        do n = l,m
        a = a + f(n)
        write(17,*) f(n),h
        END DO
       result = a*h
        write(6,*) f(100),h,result
      return
      end
***********************************************************************
